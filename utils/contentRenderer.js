...
function renderHtml(content) {
  ...
  return `
    ...
    <head>
      ...
      <title>Share AI Web Link 查看器</title>
      ...
      <meta name="apple-mobile-web-app-title" content="Share AI Web Link">
...
async function renderMarkdown(content) {
  ...
  return `
    ...
    <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Share AI Web Link Markdown查看器</title>
...
function renderSvg(content) {
  ...
  return `
    ...
    <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Share AI Web Link SVG查看器</title>
  ...
  try {
    ...
    return `
      ...
      <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Share AI Web Link Mermaid查看器</title>
...
${escapedMermaidCode}
    ...
    return `
      ...
      <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Share AI Web Link Mermaidu9519u8bef</title>
        <style>
          body {
            font-family: 'Roboto', sans-serif;
            line-height: 1.6;
